...
- 🧪 **Query**: `db.restaurants.find({},{"restaurant_id":1,"name":1,"borough":1,"address.zipcode": 1, _id: 1})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
...
- 🧪 **Query**: `db.restaurants.find({$or:[{cuisine:"Fish"},{name: /^Wil/ }],cuisine:{$nin:["American","Chinese"]}})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 1
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: COLLSCAN
...
- 🧪 **Query**: `db.restaurants.find({"grades.grade": "A","grades.score": 11,"grades.date":ISODate("2014-08-11T00:00:00Z")},{restaurant_id:1,name:1,grades:1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({"location.coordinates":{$type:"double"}},{name:1,restaurant_id:1,"location.coordinates":1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_DEFAULT
...
- 🧪 **Query**: `db.restaurants.find({name: /mon/i },{name:1,borough:1,"location.coordinates":1,cuisine:1,_id:0})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({"grades.score":{$gt:80,$lt:100}},{restaurant_id:1,name:1,grades:1,_id:0})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
