...
db.restaurants.find({},{"restaurant_id":1,"name":1,"borough":1,"address.zipcode": 1, _id: 1})
...
db.restaurants.find({$or:[{cuisine:"Fish"},{name: /^Wil/ }],cuisine:{$nin:["American","Chinese"]}})
...
db.restaurants.find({"grades.score":{$gt:80,$lt:100}},{restaurant_id:1,name:1,grades:1,_id:0})
